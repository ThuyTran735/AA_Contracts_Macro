...
readme.Add("Text", "x30 y20 w740 h40", "Contracts Macro V1.1.0")
...
main.Add("Text", "x10 y250 w200 h20 cFFFFFF", "Made By Thuy | V1.1.0")
...
Assassin_Park()
{
    ...
    if (SearchPixelColor(0xECFF29, 1302, 364, 1510, 164)) {
        SendClick(1714, 20)
