...
readme.Add("Text", "x30 y20 w740 h40", "Contracts Macro V1.2.0")
...
main.Add("Text", "x10 y250 w200 h20 cFFFFFF", "Made By Thuy | V1.2.0")
...
Checkbox2 := main.Add("Checkbox", "x10 y60 w230 h20 cFFFFFF", "Unit Slot 2 (Don't Use Hill Unit)")
Dropdown2 := main.Add("DropDownList", "x225 y60 w50 h20 Background333333 cFFFFFF r6", ["1", "2", "3", "4", "5", "6"])

Checkbox3 := main.Add("Checkbox", "x10 y90 w230 h20 cFFFFFF", "Unit Slot 3 (Don't Use Hill Unit)")
Dropdown3 := main.Add("DropDownList", "x225 y90 w50 h20 Background333333 cFFFFFF r6", ["1", "2", "3", "4", "5", "6"])

Checkbox4 := main.Add("Checkbox", "x10 y120 w230 h20 cFFFFFF", "Unit Slot 4 (Don't Use Hill Unit)")
Dropdown4 := main.Add("DropDownList", "x225 y120 w50 h20 Background333333 cFFFFFF r6", ["1", "2", "3", "4", "5", "6"])

Checkbox5 := main.Add("Checkbox", "x10 y150 w230 h20 cFFFFFF", "Unit Slot 5 (Don't Use Hill Unit)")
Dropdown5 := main.Add("DropDownList", "x225 y150 w50 h20 Background333333 cFFFFFF r6", ["1", "2", "3", "4", "5", "6"])

Checkbox6 := main.Add("Checkbox", "x10 y180 w230 h20 cFFFFFF Checked", "Unit Slot 6 (Don't Use Hill Unit)")
...
ImageFound_upgrade_num()
{
    ...
    if (ok:=FindText(&X, &Y, 0, 0, 1920, 1080, 0, 0, Num5))
    {
        return true
    }
    else
